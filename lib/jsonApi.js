...
jsonApi.router = require("./router.js");
...
jsonApi.authenticate = jsonApi.router.authenticateWith;
...
jsonApi.start = function() {
  routes.register();
  jsonApi.router.listen(jsonApi._apiConfig.port);
};

jsonApi.close = function() {
  jsonApi.router.close();
